...
document
    ...
    if (skillNodeList.length > 0) {
        ...
        skillNodeList.forEach(function (skillNode) {
            ...
            skillsF.innerHTML += "<li contenteditable=\"true\">".concat(skill, "</li>");
        });
    }
    else {
    ...
    if (experiences.length > 0) {
        ...
        experiences.forEach(function (experience, index) {
            ...
            experincehtml += "<div id=\"jt\" contenteditable=\"true\"><strong>".concat(jobTitle, "</strong></div>");
            experincehtml += "<div id=\"j1\"> <div id=\"empN\" contenteditable=\"true\"> <p> ".concat(employerName, " </p></div> <div id=\"YtoD\" contenteditable=\"true\"> <p> ").concat(processMonth(yearFrom), " - ").concat(processMonth(yearTo), "</p> </div> </div>");
            experincehtml += "<p id=\"jbl\" contenteditable=\"true\">  ".concat(jobLocation, "</p>");
            for (var i = 0; i < jobDescriptions.length; i++) {
                experincehtml += "<ul>";
                experincehtml += "<li id=\"jobdes\" contenteditable=\"true\">".concat(jobDescriptions[i].value, "</li>");
                experincehtml += "</ul>";
            }
        ...
        leftsec1.innerHTML =
            '<h3 contenteditable="true">Work Experince </h3> <p contenteditable="true">Exciting! As a fresh candidate, I am ready to embark on a professional journey with enthusiasm and a strong skill set!</p>';
    }
    // Education Section
    var educationall = "";
    ...
    if (educations.length > 0) {
        ...
        educations.forEach(function (education, index) {
            ...
            educationall += "<div id=\"eduels\"><div id=\"eduls\" contenteditable=\"true\">".concat(educationLevel, " in </div> <div id=\"edus\" contenteditable=\"true\">").concat(subject, "</div></div>");
            educationall += "<div id=\"eduip\"><div id=\"eduin\" contenteditable=\"true\">".concat(instituteName, "</div> <div id=\"edupoy\" contenteditable=\"true\">(").concat(processMonth(passedOutYear), ")</div> </div>");
            educationall += "<div id=\"edui\" contenteditable=\"true\">".concat(instituteLocation, "</div>");
